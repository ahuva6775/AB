...
export default connect(mapStateToProps, mapDispatchToProps)(function Login(props) {
    ...
    function signin() {
        // const currentUser = {
        //     nameu: userName.current.value,
        //     passu: userPass.current.value
        // }
        // ================
        // uName(userName.current.value)
        // uPassword(userPass.current.value)
        const userCurrent = {
            u: userName.current.value,
            p: userPass.current.value
        }
        // const u=userName.current.value
        // const p=userPass.current.value
        loggin(userCurrent)
    ...
    return (
        <>
            ...
            <div className="col-auto">
                ...
                <div className="input-group mb-2" style={{ width: 500, marginLeft: 500, textAlign: 'center' }}>
            ...
            <div className="col-auto">
                ...
                <div className="input-group mb-2" style={{ width: 500, marginLeft: 500, textAlign: 'center' }}>
                    ...
                    <input type="password" style={{ textAlign: 'center' }} placeholder='הכנס סיסמא' ref={userPass} className="form-control" id="inlineFormInputGroup" ></input>
                </div>
            </div>
            <br></br>
            <div className='row'>
                <button style={{ width: 250, height: 40, marginLeft: 530 }} onClick={newUser}>
                ...
                <button style={{ width: 250, height: 40 }} onClick={signin}>
